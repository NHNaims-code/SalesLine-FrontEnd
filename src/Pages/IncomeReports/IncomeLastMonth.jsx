...
export default function IncomeLastMonth() {
  ...
  return (
    <div>
      <DataTable loading={loading} tableTitle="Last Month Income" columns={columns} rows={allpayment} handleEdit={(rowData) => {setUpdateData(rowData); setOpen(true)}} handleDelete={handleDelete}/>
