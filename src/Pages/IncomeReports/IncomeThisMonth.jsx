...
export default function IncomeThisMonth() {
  ...
  return (
    <div>
      <DataTable loading={loading} tableTitle="This Month Income" columns={columns} rows={allpayment} handleEdit={(rowData) => {setUpdateData(rowData); setOpen(true)}} handleDelete={handleDelete}/>
