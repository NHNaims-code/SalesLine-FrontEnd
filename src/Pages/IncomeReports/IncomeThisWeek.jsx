...
export default function IncomeThisWeek() {
  ...
  return (
    <div>
      <DataTable loading={loading} tableTitle="This Week Income" columns={columns} rows={allpayment} handleEdit={(rowData) => {setUpdateData(rowData); setOpen(true)}} handleDelete={handleDelete}/>
