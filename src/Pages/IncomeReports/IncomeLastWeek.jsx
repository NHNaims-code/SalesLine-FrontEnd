...
export default function IncomeLastWeek() {
  ...
  return (
    <div>
      <DataTable loading={loading} tableTitle="Last Week Income" columns={columns} rows={allpayment} handleEdit={(rowData) => {setUpdateData(rowData); setOpen(true)}} handleDelete={handleDelete}/>
