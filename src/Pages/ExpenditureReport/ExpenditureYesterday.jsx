    ...
    try {
      ...
      if(!response.data == false){        
        ...
        response.data.map(data => {
          ...
          console.log("created: ", createdDate, "yesterday: ", new Date(yesterday).getDate())
...
const handleEdit = async(rowData) => {
  ...
  return (
    <div>
      <DataTable loading={loading} tableTitle="Yesterday Expenditure" columns={columns} rows={allspents} handleEdit={(rowData) => {setUpdateData(rowData); setOpen(true)}} handleDelete={handleDelete}/>
