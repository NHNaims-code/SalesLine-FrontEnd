      ...
      if(!response.data == false){        
        ...
        response.data.map(data => {
          ...
          if(createdDate == thisMonth){
            console.log(data)
            console.log("this month", {...data, item_name: data?.item?.item_name || data?.item_name})
...
const handleEdit = async(rowData) => {
  ...
  return (
    <div>
      <DataTable loading={loading} tableTitle="This Month Expenditure" columns={columns} rows={allspents} handleEdit={(rowData) => {setUpdateData(rowData); setOpen(true)}} handleDelete={handleDelete}/>
