...
export default function ExpenditureToday() {
  ...
  return (
    <div>
      <DataTable rows={allspents} columns={columns} loading={loading} tableTitle="Today Expenditure" handleEdit={(rowData) => {setUpdateData(rowData); setOpen(true)}} handleDelete={handleDelete}/>
