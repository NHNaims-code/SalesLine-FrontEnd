...
const handleEdit = async(rowData) => {
  ...
  return (
    <div>
      <DataTable loading={loading} tableTitle="This Week Expenditure" columns={columns} rows={allspents} handleEdit={(rowData) => {setUpdateData(rowData); setOpen(true)}} handleDelete={handleDelete}/>
