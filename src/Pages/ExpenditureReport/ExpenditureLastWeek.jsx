    ...
    try {
      ...
      if(!response.data == false){        
        ...
        response.data.map(data => {
          ...
          if(lastWeekStarting <= createdDate <= today.getDate()){
...
const handleEdit = async(rowData) => {
  ...
  return (
    <div>
      <DataTable loading={loading} tableTitle="Last Week Expenditure" columns={columns} rows={allspents} handleEdit={(rowData) => {setUpdateData(rowData); setOpen(true)}} handleDelete={handleDelete}/>
